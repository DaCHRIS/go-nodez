...
# 1. install ndz for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for ndz
# 5. create ndz, attach and uninstall start menu entries
...
!define GROUPNAME "Nodez"
!define APPNAME "Nodez"
!define DESCRIPTION "Official Go implementation of the Nodez protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since ndz is installed global
