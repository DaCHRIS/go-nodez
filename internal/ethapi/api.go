...
// PublicEthereumAPI provides an API to access Nodez related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicEthereumAPI struct {
	b Backend
}

// NewPublicEthereumAPI creates a new Nodez protocol API.
...
// ProtocolVersion returns the current Nodez protocol version this node supports
...
// Sign calculates an Nodez ECDSA signature for:
...
//
// https://github.com/NodezCrypto/go-nodez/wiki/Management-APIs#personal_sign
...
//
// https://github.com/NodezCrypto/go-nodez/wiki/Management-APIs#personal_ecRecover
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != 65 {
		return common.Address{}, fmt.Errorf("signature must be 65 bytes long")
	}
	if sig[64] != 27 && sig[64] != 28 {
		return common.Address{}, fmt.Errorf("invalid Nodez signature (V is not 27 or 28)")
	}
...
// PublicBlockChainAPI provides an API to access the Nodez blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new Nodez blockchain API.
...
//
// https://github.com/NodezCrypto/wiki/wiki/JSON-RPC#eth_sign
...
// PublicDebugAPI is the collection of Nodez APIs exposed over the public
// debugging endpoint.
...
// PrivateDebugAPI is the collection of Nodez APIs exposed over the private
// debugging endpoint.
