...
// Package accounts implements high level Nodez account management.
package accounts
...
// Account represents an Nodez account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Nodez account address derived from the key
