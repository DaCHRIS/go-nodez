...
// See https://github.com/NodezCrypto/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given Nodez presale wallet and stores
