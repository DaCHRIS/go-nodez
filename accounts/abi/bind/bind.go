...
// Package bind generates Nodez contract Go bindings.
//
// Detailed usage document and tutorial available on the go-nodez Wiki page:
// https://github.com/NodezCrypto/go-nodez/wiki/Native-DApps:-Go-bindings-to-Nodez-contracts
package bind
