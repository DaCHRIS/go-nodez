...
import (
	...
	"github.com/NodezCrypto/go-nodez/logger"
	"github.com/NodezCrypto/go-nodez/p2p"
	"github.com/NodezCrypto/go-nodez/p2p/nat"
	"github.com/NodezCrypto/go-nodez/whisper"
)
...
func main() {
	...
	// Create an Nodez peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting Nodez peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start Nodez peer: %v.\n", err)
		os.Exit(1)
	}
