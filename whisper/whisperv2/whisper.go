...
import (
	...
	"github.com/NodezCrypto/go-nodez/crypto/ecies"
	"github.com/NodezCrypto/go-nodez/event/filter"
...
// Whisper represents a dark communication interface through the Nodez
...
// New creates a Whisper client ready to communicate through the Nodez P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
