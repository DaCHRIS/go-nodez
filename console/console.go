...
import (
	...
	"github.com/NodezCrypto/go-nodez/internal/jsre"
	"github.com/NodezCrypto/go-nodez/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute Nodez requests through
...
func (c *Console) init(preload []string) error {
	...
	flatten := "var eth = web3.eth; var ndz = web3.eth; var personal = web3.personal; "
	for api := range apis {
		if api == "web3" {
...
// Welcome show summary of current Nodez instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Nodez metadata
	fmt.Fprintf(c.printer, "Welcome to the Nodez JavaScript console!\n\n")
	c.jsre.Run(`
