...
import (
	...
	"github.com/NodezCrypto/go-nodez/accounts/keystore"
	"github.com/NodezCrypto/go-nodez/common"
	"github.com/NodezCrypto/go-nodez/core"
	"github.com/NodezCrypto/go-nodez/core/types"
	"github.com/NodezCrypto/go-nodez/eth"
	"github.com/NodezCrypto/go-nodez/eth/downloader"
	"github.com/NodezCrypto/go-nodez/ethclient"
	"github.com/NodezCrypto/go-nodez/ethstats"
	"github.com/NodezCrypto/go-nodez/les"
	"github.com/NodezCrypto/go-nodez/log"
	"github.com/NodezCrypto/go-nodez/node"
	"github.com/NodezCrypto/go-nodez/p2p"
	"github.com/NodezCrypto/go-nodez/p2p/discover"
	"github.com/NodezCrypto/go-nodez/p2p/discv5"
	"github.com/NodezCrypto/go-nodez/p2p/nat"
...
var (
	...
	netFlag     = flag.Uint64("network", 0, "Network ID to use for the Nodez protocol")
	...
	logFlag    = flag.Int("loglevel", 3, "Log level to use for Nodez and the faucet")
)
...
type request struct {
	...
	Account common.Address     `json:"account"` // Nodez address being funded
	Time    time.Time          `json:"time"`    // Timestamp when the request was accepted
	Tx      *types.Transaction `json:"tx"`      // Transaction funding the account
}

// faucet represents a crypto faucet backed by an Nodez light client.
type faucet struct {
	config *params.ChainConfig // Chain configurations for signing
	stack  *node.Node          // Nodez protocol stack
	client *ethclient.Client   // Client connection to the Nodez chain
...
func newFaucet(genesis *core.Genesis, port int, enodes []*discv5.Node, network uint64, stats string, ks *keystore.KeyStore, index []byte) (*faucet, error) {
	...
	// Assemble the Nodez light client protocol
...
// close terminates the Nodez connection and tears down the faucet.
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		// Retrieve the Nodez address to fund, the requesting user and a profile picture
		var (
			username string
			avatar   string
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/NodezCrypto/go-nodez/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
...
// the username, avatar URL and Nodez address to fund on success.
func authGitHub(url string) (string, string, common.Address, error) {
	...
	// Iterate over all the files and look for Nodez addresses
	...
	if address == (common.Address{}) {
		return "", "", common.Address{}, errors.New("No Nodez address found to fund")
	}
...
func authTwitter(url string) (string, string, common.Address, error) {
	...
	// scrape it for the Nodez address and profile URL.
...
// returning the username, avatar URL and Nodez address to fund on success.
...
// authNoAuth tries to interpret a faucet request as a plain Nodez address,
