...
import (
	...
	"github.com/NodezCrypto/go-nodez/contracts/ens"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:   "swap-api",
		Usage:  "URL of the Nodez API provider to use to settle SWAP payments",
	...
	EnsAPIFlag = cli.StringFlag{
		Name:   "ens-api",
		Usage:  "URL of the Nodez API provider to use for ENS record lookups",
...
// This init function sets defaults so cmd/swarm can run alongside ndz.
func init() {
...
var app = utils.NewApp(gitCommit, "Nodez Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2018 The CryptoNodez Team"
...
func bzzd(ctx *cli.Context) error {
	...
	//ndz only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for ndz and swarm
