...
import (
	...
	"github.com/NodezCrypto/go-nodez/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Nodez contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Nodez contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Nodez contract Solidity source to build and bind")
