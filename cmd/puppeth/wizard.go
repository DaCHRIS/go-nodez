...
type wizard struct {
	...
	services map[string][]string   // Nodez services known to be running on servers
...
// converts it to an Nodez address. If an empty line is entered, the default
// value is returned.
