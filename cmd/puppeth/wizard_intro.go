...
// setting up a new or managing an existing Nodez private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Nodez private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Nodez network down to  |")
	...
	log.Info("Administering Nodez network", "name", w.network)
