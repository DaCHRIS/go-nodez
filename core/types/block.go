...
// Package types contains data types related to Nodez consensus.
package types
...
// Header represents a block header in the Nodez blockchain.
type Header struct {
...
// Block represents an entire block in the Nodez blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Nodez RLP block format.
