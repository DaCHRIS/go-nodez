...
import (
	...
	"github.com/NodezCrypto/go-nodez/crypto/sha3"
...
// ecrecover extracts the Nodez account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Nodez address
...
// Nodez testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Nodez address of the signing key
...
// Author implements consensus.Engine, returning the Nodez address recovered
