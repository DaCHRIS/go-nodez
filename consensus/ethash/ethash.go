...
// all blocks' seal as valid, though they still have to conform to the Nodez
// consensus rules.
...
// still have to conform to the Nodez consensus rules.
...
// they still have to conform to the Nodez consensus rules.
