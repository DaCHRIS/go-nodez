...
import (
	...
	"github.com/NodezCrypto/go-nodez/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Nodez
...
func (eth *Nodez) startBloomHandlers() {
...
// for the Nodez header bloom filters, permitting blazing fast filtering.
