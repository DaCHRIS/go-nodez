...
// PeerInfo represents a short summary of the Nodez sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Nodez protocol version negotiated
