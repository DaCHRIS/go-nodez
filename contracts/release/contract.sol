...
// ReleaseOracle is an Nodez contract to store the current and previous
// versions of the go-nodez implementation. Its goal is to allow Nodez to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Nodez releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Nodez release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an Nodez user, either
