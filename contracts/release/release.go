...
type Config struct {
	Oracle common.Address // Nodez address of the release oracle
...
func NewReleaseService(ctx *node.ServiceContext, config Config) (node.Service, error) {
	// Retrieve the Nodez service dependency to access the blockchain
	var apiBackend ethapi.Backend
	var ethereum *eth.Nodez
...
func (r *ReleaseService) checkVersion() {
	...
	if version.Major > r.config.Major ||
		...
		howtofix := fmt.Sprintf("Please check https://github.com/NodezCrypto/go-nodez/releases for new releases")
