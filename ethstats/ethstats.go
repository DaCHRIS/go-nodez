...
// Service implements an Nodez netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Nodez      // Full Nodez service if monitoring a full node
	les    *les.LightEthereum // Light Nodez service if monitoring a light node
...
func New(url string, ethServ *eth.Nodez, lesServ *les.LightEthereum) (*Service, error) {
